                ...
                <form method="post" action="{{ route('appointments.update', $appointment->id) }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-5 bg-white dark:bg-gray-800 sm:p-6">
                            ...
                            <input name="description" id="description" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full"
                        ...
                        <div class="px-4 py-5 bg-white dark:bg-gray-800 sm:p-6">
                            <input name="end_date" id="end_date" type="date" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('end_date', $appointment->end_date) }}" />
                            @error('end_date')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
