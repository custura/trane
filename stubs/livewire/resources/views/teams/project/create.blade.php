            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="post" action="{{ route('projects.store') }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white dark:bg-gray-800 sm:p-6">
                            <label for="pause" class="block font-medium text-sm text-gray-700">Pause system</label>
                            <input type="text" name="pause" id="pause" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="ToDo" />
                            @error('pause')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="px-4 py-5 bg-white dark:bg-gray-800 sm:p-6">
                            <label for="tasks" class="block font-medium text-sm text-gray-700">Tasks</label>
                            <input type="text" name="tasks" id="tasks" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="Tasks" />
                            @error('tasks')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
