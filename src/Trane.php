...
use Custura\Trane\Contracts\DeletesUsers;
use Custura\Trane\Contracts\InvitesTeamMembers;
use Custura\Trane\Contracts\RemovesTeamMembers;
use Custura\Trane\Contracts\UpdatesTeamNames;

class Trane
{
    /**
     * Indicates if Trane routes will be registered.
     *
     * @var bool
     */
    ...
    /**
     * The user model that should be used by Trane.
     *
     * @var string
     */
    ...
    /**
     * The team model that should be used by Trane.
     *
     * @var string
     */
    ...
    /**
     * The membership model that should be used by Trane.
     *
     * @var string
     */
    ...
    /**
     * The team invitation model that should be used by Trane.
     *
     * @var string
     */
    ...
    /**
     * Determine if Trane has registered roles.
     *
     * @return bool
     */
    ...
    /**
     * Determine if any permissions have been registered with Trane.
     *
     * @return bool
     */
    ...
    /**
     * Determine if Trane is managing profile photos.
     *
     * @return bool
     */
    ...
    /**
     * Determine if Trane is supporting API features.
     *
     * @return bool
     */
    ...
    /**
     * Determine if Trane is supporting team features.
     *
     * @return bool
     */
    ...
    /**
     * Specify the user model that should be used by Trane.
     *
     * @param  string  $model
     * @return static
     */
    ...
    /**
     * Specify the team model that should be used by Trane.
     *
     * @param  string  $model
     * @return static
     */
    ...
    /**
     * Specify the membership model that should be used by Trane.
     *
     * @param  string  $model
     * @return static
     */
    ...
    /**
     * Specify the team invitation model that should be used by Trane.
     *
     * @param  string  $model
     * @return static
     */
    ...
    /**
     * Configure Trane to not register its routes.
     *
     * @return static
     */
