...
use Custura\Trane\Actions\UpdateTeamMemberRole;
...
class TeamMemberManager extends Component
{
    ...
    public function manageRole($userId)
    {
        ...
        $this->managingRoleFor = Trane::findUserByIdOrFail($userId);
     ...
     *
     * @param  \Custura\Trane\Actions\UpdateTeamMemberRole  $updater
     * @return void
     */
     ...
     *
     * @param  \Custura\Trane\Contracts\RemovesTeamMembers  $remover
     * @return void
     */
    ...
    public function removeTeamMember(RemovesTeamMembers $remover)
    {
        $remover->remove(
            $this->user,
            $this->team,
            $user = Trane::findUserByIdOrFail($this->teamMemberIdBeingRemoved)
        );
    ...
    {
        return collect(Trane::$roles)->transform(function ($role) {
