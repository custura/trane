...
class ApiTokenManager extends Component
{
    ...
    {
        $this->createApiTokenForm['permissions'] = Trane::$defaultPermissions;
    }
    ...
    public function createApiToken()
    {
        ...
        $this->displayTokenValue($this->user->createToken(
            ...
            Trane::validPermissions($this->createApiTokenForm['permissions'])
        ));
    ...
    public function updateApiToken()
    {
        $this->managingPermissionsFor->forceFill([
            'abilities' => Trane::validPermissions($this->updateApiTokenForm['permissions']),
        ])->save();
